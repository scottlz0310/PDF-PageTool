...
#### **2.2 ドラッグ&ドロップ**
- [❌️] エクスプローラーからPDFファイルをドラッグして入力エリアにドロップできる **🚫アイコンがでてドロップできない**
- [❌️] 複数ファイルを同時にドラッグ&ドロップできる
- [✅️] PDF以外のファイルをドロップした場合、無視される **PDFも全て無視される**
...
#### **5.2 順序変更**
- [❌️] 出力エリア内でページをドラッグして順序を変更できる **登録解除になってしまう**
- [✅️] 指定位置への挿入が正確に動作する
